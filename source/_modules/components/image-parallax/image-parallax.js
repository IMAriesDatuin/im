...
var imageParallax = (function imageParallax($, window, document, undefined) {
	...
	var init = function init($element) {
        ...
        //removeIf(production)
        get.info('imageParallax', '1.0', 'Aries Datuin');
        ...
        ! function(t) {
                    ...
                    return a(t, [{
                        ...
                        value: function() {
                            ...
                            */
                            ...
                            $doc.find(".image-parallax").on("mousemove", _.throttle( function(e) { 

                                var self = this;

                                var parallaxIt = function parallaxIt() {

                                    var i = self.offsetWidth * 0.5,
                                        a = self.offsetHeight * 0.5,
                                        mouseX = e.clientX,
                                        mouseY = e.clientY;

                                    //console.log(i, a);

                                    t.mouseTargetX = ( i - mouseX ) / i, t.mouseTargetY = (a - mouseY) / a
    						...
    						var options = {
    							container: document,
    							elements_selector: ".image-parallax",
    							threshold: 0,
    							...
    							callback_enter: function(element) {
    								...
    								}, 66, { leading: $interval.leading, trailing: $interval.trailing } ));
            ...
            console.log('Image parallax element does not exist.');
            return false;
